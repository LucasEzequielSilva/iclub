    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-black/95 backdrop-blur-md border-t border-white/10 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
      <div className="flex items-center justify-between gap-4">
        ...
        <a
          ...
          className="cursor-pointer shrink-0 flex items-center gap-2 px-5 py-3 min-h-[44px] bg-green-500 hover:bg-green-600 active:bg-green-700 text-white rounded-full text-sm font-semibold transition-colors"
        >
