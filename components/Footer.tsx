      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-center">
          <a
            ...
            className="text-slate-400 hover:text-green-400 transition-colors min-w-[44px] min-h-[44px] inline-flex items-center justify-center cursor-pointer"
            aria-label="WhatsApp"
          >
        ...
        <p className="text-xs sm:text-sm text-slate-500 text-center">
          © {new Date().getFullYear()} TrendSpot. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
